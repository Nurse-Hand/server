-- Integrate Task and Handoff domain schemas with Foundation scope constraints.

-- Bound dispatcher scans by operation and lease state before scope extraction.
CREATE INDEX "AiJob_dispatch_queue_idx" ON "AiJob"("operation", "status", "leaseExpiresAt", "datasetId", "wardId", "createdAt", "id");
...
CREATE TABLE "HandoffPrecheck" (
    ...
    "operation" VARCHAR(100) NOT NULL DEFAULT 'handoffs.precheck',
...
CREATE TABLE "HandoffGenerationAttempt" (
    ...
    "wardId" UUID NOT NULL,
    "operation" VARCHAR(100) NOT NULL DEFAULT 'handoffs.generate',
    "aiJobId" UUID NOT NULL,
    "idempotencyRecordId" UUID NOT NULL,
    "requestHash" CHAR(64) NOT NULL,
    "requestId" UUID NOT NULL,
...
CREATE TABLE "HandoffFinalSnapshot" (
    ...
    "operation" VARCHAR(100) NOT NULL DEFAULT 'handoffs.finalize',
...
CREATE TABLE "HandoffAcknowledgement" (
    ...
    "senderActorId" UUID NOT NULL,
    "receiverActorId" UUID NOT NULL,
    "operation" VARCHAR(100) NOT NULL DEFAULT 'handoffs.acknowledge',
...
-- CreateIndex
CREATE UNIQUE INDEX "HandoffPrecheck_datasetId_aiJobId_senderActorId_wardId_oper_key" ON "HandoffPrecheck"("datasetId", "aiJobId", "senderActorId", "wardId", "operation");

-- CreateIndex
CREATE UNIQUE INDEX "HandoffPrecheck_datasetId_idempotencyRecordId_senderActorId_key" ON "HandoffPrecheck"("datasetId", "idempotencyRecordId", "senderActorId", "wardId", "operation");
...
-- CreateIndex
CREATE UNIQUE INDEX "HandoffGenerationAttempt_datasetId_aiJobId_actorId_wardId_o_key" ON "HandoffGenerationAttempt"("datasetId", "aiJobId", "actorId", "wardId", "operation");

-- CreateIndex
CREATE UNIQUE INDEX "HandoffGenerationAttempt_datasetId_idempotencyRecordId_acto_key" ON "HandoffGenerationAttempt"("datasetId", "idempotencyRecordId", "actorId", "wardId", "operation");
...
-- CreateIndex
CREATE UNIQUE INDEX "HandoffFinalSnapshot_datasetId_idempotencyRecordId_finalize_key" ON "HandoffFinalSnapshot"("datasetId", "idempotencyRecordId", "finalizedByActorId", "wardId", "operation");
...
-- CreateIndex
CREATE UNIQUE INDEX "HandoffAcknowledgement_datasetId_idempotencyRecordId_receiv_key" ON "HandoffAcknowledgement"("datasetId", "idempotencyRecordId", "receiverActorId", "wardId", "operation");
...
-- AddForeignKey
ALTER TABLE "HandoffPrecheck" ADD CONSTRAINT "HandoffPrecheck_datasetId_fkey" FOREIGN KEY ("datasetId") REFERENCES "DemoDataset"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HandoffPrecheck" ADD CONSTRAINT "HandoffPrecheck_datasetId_senderActorId_wardId_fkey" FOREIGN KEY ("datasetId", "senderActorId", "wardId") REFERENCES "WardMembership"("datasetId", "nurseId", "wardId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HandoffPrecheck" ADD CONSTRAINT "HandoffPrecheck_datasetId_receiverActorId_wardId_fkey" FOREIGN KEY ("datasetId", "receiverActorId", "wardId") REFERENCES "WardMembership"("datasetId", "nurseId", "wardId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HandoffPrecheck" ADD CONSTRAINT "HandoffPrecheck_datasetId_senderShiftId_senderActorId_ward_fkey" FOREIGN KEY ("datasetId", "senderShiftId", "senderActorId", "wardId") REFERENCES "NurseShift"("datasetId", "id", "nurseId", "wardId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HandoffPrecheck" ADD CONSTRAINT "HandoffPrecheck_datasetId_receiverShiftId_receiverActorId__fkey" FOREIGN KEY ("datasetId", "receiverShiftId", "receiverActorId", "wardId") REFERENCES "NurseShift"("datasetId", "id", "nurseId", "wardId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HandoffPrecheck" ADD CONSTRAINT "HandoffPrecheck_datasetId_aiJobId_senderActorId_wardId_ope_fkey" FOREIGN KEY ("datasetId", "aiJobId", "senderActorId", "wardId", "operation") REFERENCES "AiJob"("datasetId", "id", "actorId", "wardId", "operation") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HandoffPrecheck" ADD CONSTRAINT "HandoffPrecheck_datasetId_idempotencyRecordId_senderActorI_fkey" FOREIGN KEY ("datasetId", "idempotencyRecordId", "senderActorId", "wardId", "operation") REFERENCES "IdempotencyRecord"("datasetId", "id", "actorId", "wardId", "operation") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HandoffPrecheckPatientInput" ADD CONSTRAINT "HandoffPrecheckPatientInput_datasetId_patientId_fkey" FOREIGN KEY ("datasetId", "patientId") REFERENCES "Patient"("datasetId", "id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HandoffPrecheckTimelineInput" ADD CONSTRAINT "HandoffPrecheckTimelineInput_datasetId_timelineEventId_fkey" FOREIGN KEY ("datasetId", "timelineEventId") REFERENCES "TimelineEvent"("datasetId", "id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HandoffPrecheckTaskInput" ADD CONSTRAINT "HandoffPrecheckTaskInput_datasetId_taskId_fkey" FOREIGN KEY ("datasetId", "taskId") REFERENCES "Task"("datasetId", "id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Handoff" ADD CONSTRAINT "Handoff_datasetId_fkey" FOREIGN KEY ("datasetId") REFERENCES "DemoDataset"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Handoff" ADD CONSTRAINT "Handoff_datasetId_senderActorId_wardId_fkey" FOREIGN KEY ("datasetId", "senderActorId", "wardId") REFERENCES "WardMembership"("datasetId", "nurseId", "wardId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Handoff" ADD CONSTRAINT "Handoff_datasetId_receiverActorId_wardId_fkey" FOREIGN KEY ("datasetId", "receiverActorId", "wardId") REFERENCES "WardMembership"("datasetId", "nurseId", "wardId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Handoff" ADD CONSTRAINT "Handoff_datasetId_senderShiftId_senderActorId_wardId_fkey" FOREIGN KEY ("datasetId", "senderShiftId", "senderActorId", "wardId") REFERENCES "NurseShift"("datasetId", "id", "nurseId", "wardId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Handoff" ADD CONSTRAINT "Handoff_datasetId_receiverShiftId_receiverActorId_wardId_fkey" FOREIGN KEY ("datasetId", "receiverShiftId", "receiverActorId", "wardId") REFERENCES "NurseShift"("datasetId", "id", "nurseId", "wardId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HandoffGenerationAttempt" ADD CONSTRAINT "HandoffGenerationAttempt_datasetId_aiJobId_actorId_wardId__fkey" FOREIGN KEY ("datasetId", "aiJobId", "actorId", "wardId", "operation") REFERENCES "AiJob"("datasetId", "id", "actorId", "wardId", "operation") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "HandoffGenerationAttempt" ADD CONSTRAINT "HandoffGenerationAttempt_datasetId_idempotencyRecordId_act_fkey" FOREIGN KEY ("datasetId", "idempotencyRecordId", "actorId", "wardId", "operation") REFERENCES "IdempotencyRecord"("datasetId", "id", "actorId", "wardId", "operation") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HandoffDraftPatient" ADD CONSTRAINT "HandoffDraftPatient_datasetId_patientId_fkey" FOREIGN KEY ("datasetId", "patientId") REFERENCES "Patient"("datasetId", "id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HandoffDraftLinkedTask" ADD CONSTRAINT "HandoffDraftLinkedTask_datasetId_taskId_fkey" FOREIGN KEY ("datasetId", "taskId") REFERENCES "Task"("datasetId", "id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "HandoffAcknowledgement" ADD CONSTRAINT "HandoffAcknowledgement_datasetId_idempotencyRecordId_recei_fkey" FOREIGN KEY ("datasetId", "idempotencyRecordId", "receiverActorId", "wardId", "operation") REFERENCES "IdempotencyRecord"("datasetId", "id", "actorId", "wardId", "operation") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Task" ADD CONSTRAINT "Task_datasetId_fkey" FOREIGN KEY ("datasetId") REFERENCES "DemoDataset"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Task" ADD CONSTRAINT "Task_datasetId_actorId_wardId_fkey" FOREIGN KEY ("datasetId", "actorId", "wardId") REFERENCES "WardMembership"("datasetId", "nurseId", "wardId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Task" ADD CONSTRAINT "Task_datasetId_patientId_wardId_fkey" FOREIGN KEY ("datasetId", "patientId", "wardId") REFERENCES "Patient"("datasetId", "id", "wardId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "TaskCreateReceipt" ADD CONSTRAINT "TaskCreateReceipt_datasetId_idempotencyRecordId_actorId_wa_fkey" FOREIGN KEY ("datasetId", "idempotencyRecordId", "actorId", "wardId", "operation") REFERENCES "IdempotencyRecord"("datasetId", "id", "actorId", "wardId", "operation") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "TaskPriorityAudit" ADD CONSTRAINT "TaskPriorityAudit_datasetId_actorId_fkey" FOREIGN KEY ("datasetId", "actorId") REFERENCES "Nurse"("datasetId", "id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TaskExtractionJob" ADD CONSTRAINT "TaskExtractionJob_datasetId_id_actorId_wardId_operation_fkey" FOREIGN KEY ("datasetId", "id", "actorId", "wardId", "operation") REFERENCES "AiJob"("datasetId", "id", "actorId", "wardId", "operation") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TaskExtractionJob" ADD CONSTRAINT "TaskExtractionJob_datasetId_roundingSessionId_fkey" FOREIGN KEY ("datasetId", "roundingSessionId") REFERENCES "RoundingSession"("datasetId", "id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "TaskExtractionRequestReceipt" ADD CONSTRAINT "TaskExtractionRequestReceipt_datasetId_idempotencyRecordId_fkey" FOREIGN KEY ("datasetId", "idempotencyRecordId", "actorId", "wardId", "operation") REFERENCES "IdempotencyRecord"("datasetId", "id", "actorId", "wardId", "operation") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "TaskExtractionEvidence" ADD CONSTRAINT "TaskExtractionEvidence_datasetId_timelineEventId_fkey" FOREIGN KEY ("datasetId", "timelineEventId") REFERENCES "TimelineEvent"("datasetId", "id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "TaskExtractionCandidate" ADD CONSTRAINT "TaskExtractionCandidate_datasetId_patientId_fkey" FOREIGN KEY ("datasetId", "patientId") REFERENCES "Patient"("datasetId", "id") ON DELETE RESTRICT ON UPDATE CASCADE;
