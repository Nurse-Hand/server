...
- `AI_BASE_URL` (업무 우선순위 제안 AI 서버 URL, 미설정 시 해당 endpoint는 `503`)
- `AI_INTERNAL_API_TOKEN` (내부 AI 호출 토큰, 미설정 시 해당 endpoint는 `503`)
- `AI_PRIORITY_TIMEOUT_MS` (선택, 기본 `15000`, 최대 `120000`)
- `POSTGRES_DATA_DIR`
- `AI_DATA_DIR`
- `AI_TMP_DIR`
- `API_DOMAIN`
